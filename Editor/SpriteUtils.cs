...
{
    /// <summary>
    /// Helper class to show the preview Inspector for all custom image-components. mostly copied from internal UnityEditor.UI SpriteDrawUtility Class
    /// </summary>
