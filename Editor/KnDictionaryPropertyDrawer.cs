...
// File name: KnDictionaryPropertyDrawer.cs
...
[CustomPropertyDrawer(typeof(KnDictionary<,>), true)]
public class KnDictionaryPropertyDrawer : PropertyDrawer
{
    const string KeysFieldName      = "m_keys";
    const string ValuesFieldName    = "m_values";
    const float  IndentWidth        = 15f;
    const float  MaxKeyWidth        = 120f;
    const float  MaxKeyWidthPercent = 0.75f;
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (property.isExpanded) labelPosition.xMax -= m_buttonStyle.CalcSize(m_iconPlus).x;
    ...
    static KnDictionaryPropertyDrawer()
    {
    ...
    static IEnumerable<EnumerationEntry> EnumerateEntries(SerializedProperty keyArrayProperty, SerializedProperty valueArrayProperty,
                                                          int                startIndex = 0)
    {
